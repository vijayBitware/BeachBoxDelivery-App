...
public class ModelUpcomingOrder {
    public String name,order,date,timings,status,restaurant_id,id,restaurant_image,created_user_id,delivery_user_id,rs_name,rs_description,tip_amount,total_amount,sub_total,sales_tax;
    public String user_lat,user_lng,order_type,b_address1,created_at,rating;
    ...
    public String getRs_description() {
        return rs_description;
    }

    public void setRs_description(String rs_description) {
